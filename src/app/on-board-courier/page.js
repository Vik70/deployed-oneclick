...
export const metadata = {
  alternates: {
    canonical: "https://oneclickhandling.co.uk/on-board-courier",
  },
};
...
export default function OnBoardCourierPage() {
  return (
    <div className="body-dark-bg">
      <div className="fix">
      <HeaderFour/>
        <PageHeader title="On Board Courier" />
        <ServiceDetails title="On Board Courier Services" transportType="on-board-courier"
