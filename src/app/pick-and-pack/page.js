...
export const metadata = {
  alternates: {
    canonical: "https://oneclickhandling.co.uk/pick-and-pack",
  },
};
...
export default function PickAndPackPage() {
  return (
    <div className="body-dark-bg">
      <div className="fix">
      <HeaderFour/>
        <PageHeader title="Pick and Pack" />
        <ServiceDetails title="Pick and Pack Services" transportType="pick-and-pack"
